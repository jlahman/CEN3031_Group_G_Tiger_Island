...
/**
 * Created by Justin Lahman on 4/16/17.
 */
public class GameState {
    ...
    public GameState(GameState gs){
       /* player1 = new Player("Player 1");
        ...
        tilesRemaining = 48;
        board = new Board();*/
       /*TODO: Add a way to make this gamestate the same as gs, but able to edit it without editing gs
        *    //make copy methods for each object, or make this immutable, would require lots of refactoring though.
        *    //This is so that we can evaluate each and every playable move and choose the one with highest positive
        *    //difference between Player1 control and Player2 control*/
    }
